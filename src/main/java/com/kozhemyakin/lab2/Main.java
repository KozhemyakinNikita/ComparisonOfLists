...
public class Main {
    ...
    /**
     * Prints the comparison table header and calls the method to print the comparison rows.
     *
     * @param comparator         The Comparison instance used for method calls and time measurements.
     * @param arrayList          The ArrayList to be compared.
     * @param linkedList         The LinkedList to be compared.
     * @param numberOfExecutions The number of executions for each method.
     */
    private static void printComparisonTable(Comparison comparator, List<Integer> arrayList, List<Integer> linkedList, int numberOfExecutions) {
    ...
    /**
     * Prints the comparison rows for various operations between ArrayList and LinkedList.
     *
     * @param comparator         The Comparison instance used for method calls and time measurements.
     * @param arrayList          The ArrayList to be compared.
     * @param linkedList         The LinkedList to be compared.
     * @param numberOfExecutions The number of executions for each method.
     */
    private static void printCompare(Comparison comparator, List<Integer> arrayList, List<Integer> linkedList, int numberOfExecutions) {
    ...
    /**
     * Prints a single row in the comparison table for a specific operation.
     *
     * @param operation          The name of the operation.
     * @param arrayListTime      The execution time for the ArrayList.
     * @param linkedListTime     The execution time for the LinkedList.
